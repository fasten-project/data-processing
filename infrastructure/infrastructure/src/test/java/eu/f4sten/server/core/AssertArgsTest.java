...
import static eu.f4sten.server.core.AssertArgs.TEXT_ERROR_INTRO;
import static eu.f4sten.server.core.AssertArgs.TEXT_GENERIC_ERROR;
import static eu.f4sten.server.core.AssertArgs.TEXT_INTRO_FOR_PARAMS;
import static eu.f4sten.server.core.AssertArgs.TEXT_IS_NULL_ERROR;
