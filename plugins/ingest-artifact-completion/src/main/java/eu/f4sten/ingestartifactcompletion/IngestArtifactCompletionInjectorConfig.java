...
@InjectorConfig
public class IngestArtifactCompletionInjectorConfig implements IInjectorConfig {
    private IngestArtifactCompletionArgs args;

    public void IngestArtifactCompletionArgs(IngestArtifactCompletionArgs args) {
        this.args = args;
    }

    @Override
    public void configure(Binder binder) {
        binder.bind(IngestArtifactCompletionArgs.class).toInstance(args);
    }
